...
def main(path):
    ...
    np.save("../data/features/local_feature/" + path.split('/')[-1].split('.')[0] + ".npy", local_feature)
    ...
    np.save("../data/features/global_feature/" + path.split('/')[-1].split('.')[0] + ".npy", global_feature)

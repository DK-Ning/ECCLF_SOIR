...
def split_data():
    ...
    train_local_feature = local_features[:7000, :, :]
    train_edge_local_feature = edge_local_features[:7000, :, :]
    train_label = label[:7000]

    test_local_feature = local_features[7000:, :, :]
    test_edge_local_feature = edge_local_features[7000:, :, :]
    test_label = label[7000:]

    train_global_feature = global_features[:7000, :]
    train_edge_global_feature = edge_global_features[:7000, :]
    test_global_feature = global_features[7000:, :]
